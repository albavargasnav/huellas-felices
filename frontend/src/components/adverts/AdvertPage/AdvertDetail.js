  ...
  return (
    <div className="contenedor-detalle">
      <div className="contenedor-foto">
        ...
        />
        <h3 className="enunciado">
          {disponible ? (
            <span className="enunciado-verde">Disponible</span>
          ) : (
            <span className="enunciado-rojo">Adoptado</span>
          )}
        </h3>
      </div>
      <div className="contenedor-datos">
        ...
        <div className="boton">
        <AdoptaButton /> {/* Aquí se muestra el botón AdoptaButton */}
      </div>
      </div>
